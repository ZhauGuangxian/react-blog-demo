    ...
    componentDidMount() {
        ...
        fetchPost('/api/articles/articleInfo', { id }).then(res => {
            if (res.message == 'success') {
                ...
                this.editor.txt.html(articleInfo.content)
            }
        })
    }
    render() {
        ...
        return (
            <div className="articlesListContainer addArticleContainer">
                ...
                <div className="setTitle">
                    <p>文章标题</p>
                    <textarea className="titleForm" cols="30" rows="10" placeholder="请输入文章标题" onChange={this.handleArticlePoortxt.bind(this, 1)} value={this.state.articleInfo.title}></textarea>
                </div>
                <div className="setDesc">
                    <p>文章摘要</p>
                    <textarea className="DescForm" cols="30" rows="10" placeholder="请输入文章摘要" onChange={this.handleArticlePoortxt.bind(this, 2)} value={this.state.articleInfo.article_desc}></textarea>
                </div>
                <div className="setDesc">
                    <p>文章封面</p>
                    <Upload
...
const UpdateArticle = withRouter(AddArticleO);
